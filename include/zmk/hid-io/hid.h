...
static const uint8_t zmk_hid_report_desc_alt[] = {
    ...
    HID_USAGE(HID_USAGE_CONSUMER_NUMERIC_KEY_PAD),
    HID_COLLECTION(HID_COLLECTION_LOGICAL),
    HID_USAGE_PAGE(HID_USAGE_CONSUMER),
    ...
    HID_REPORT_SIZE(0x08),
    HID_OUTPUT(ZMK_HID_MAIN_VAL_DATA | ZMK_HID_MAIN_VAL_VAR | ZMK_HID_MAIN_VAL_ABS),
    // HID_OUTPUT(ZMK_HID_MAIN_VAL_DATA | ZMK_HID_MAIN_VAL_VAR | ZMK_HID_MAIN_VAL_ABS | ZMK_HID_MAIN_VAL_NO_WRAP | ZMK_HID_MAIN_VAL_LIN  | ZMK_HID_MAIN_VAL_NO_PREFERRED),
    HID_END_COLLECTION,
    HID_END_COLLECTION,
#endif // IS_ENABLED(CONFIG_ZMK_HID_IO_OUTPUT)
